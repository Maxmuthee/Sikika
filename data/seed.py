...
PROJECTS = [
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Nakuru imependekeza shilingi milioni tano ruzuku ya mbolea Molo. Baraza 10 Julai, Molo Hall. Piga *384*7030# kupiga kura.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: Nakuru proposed KSh 5 million fertilizer subsidy for Molo. Baraza 10 July, Molo Hall. Dial *384*7030# to vote.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada mpya wa Vilipuzi unaweka leseni na adhabu kwa wanaotumia baruti. Piga *384*7030# kujifunza na kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: A new Explosives Bill sets licences, permits & penalties for handling blasting materials. Dial *384*7030# to learn & comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Nakuru imetenga shilingi milioni 413 kwa ukarabati wa maji na visima. Piga *384*7030# kuona na kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: Nakuru set aside KSh 413 million to rehabilitate water systems & boreholes. Dial *384*7030# to view & comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Nakuru inapanga kukarabati zaidi ya kilomita 800 za barabara. Barabara za Naivasha zimo. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: Nakuru plans to upgrade over 800 km of roads; Naivasha ward roads included. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Nakuru inapanga kuboresha hospitali na zahanati na kuongeza huduma bora. Piga *384*7030# kuona na kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: Nakuru plans to upgrade hospitals & dispensaries and widen access to care. Dial *384*7030# to view & comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada wa Fedha 2026 unapendekeza mabadiliko ya kodi yanayogusa bei na biashara. Piga *384*7030# kujifunza na kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: The Finance Bill 2026 proposes tax changes affecting prices & businesses. Dial *384*7030# to learn & comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Pesa za maendeleo ya kata Rongai zitajenga barabara ndogo, mifereji na maji. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: Rongai ward development funds local roads, drainage & water points. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada wa kubadilisha Katiba unazuia magavana wa zamani kugombea kwa miaka mitano. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: A bill to amend the Constitution bars ex-governors from office for 5 years. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada wa Maendeleo Sawa ya Kata unahakikisha kila kata inapata fedha za haki. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: The County Wards Equitable Development Bill ensures every ward gets a fair share of funds. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada mpya unataka kusajili wakulima na kuweka taarifa za kilimo kidijitali. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: A new bill registers farmers and stores farm data digitally. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada wa Ulinzi wa Mifugo unalinda ng'ombe na kudhibiti wizi na magonjwa. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: The Livestock Protection Bill guards cattle and curbs theft & disease. Dial *384*7030# to comment.",
    ...
    },
    {
        ...
        "t": {
            "sw": {
                ...
                "sms_alert": "Sikika: Mswada unataka kuweka bei ya chini ya uhakika kwa mazao ya wakulima. Piga *384*7030# kutoa maoni.",
            ...
            "en": {
                ...
                "sms_alert": "Sikika: A bill would set a guaranteed minimum price for farmers' produce. Dial *384*7030# to comment.",
